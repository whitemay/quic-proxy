...
#[derive(Parser, Debug)]
struct Certs {
    #[arg(long, short, default_value = "local.coolman.me", help = "Server name.")]
    server_name: String,
    #[arg(
        long,
        short,
        default_value = "certs/fullchain5.pem",
    ...
    #[arg(
        long,
        short,
        default_value = "certs/privkey5.pem",
...
async fn run(options: Options) -> io::Result<()> {
    ...
    parameters.set_max_idle_timeout(Duration::from_secs(600));
